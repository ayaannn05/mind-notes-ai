    ...
    if (error) return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-orange-50 px-4">
            <div className="text-center bg-white p-6 sm:p-8 rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-300 w-full max-w-md">
                <h2 className="text-2xl sm:text-3xl font-bold text-red-600 mb-4">Error Loading Note</h2>
                <p className="text-gray-600 mb-6">{error}</p>
                <Link to="/dashboard" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-white bg-gradient-to-r from-[#F17905] to-[#d66804] rounded-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                    Return to Dashboard
                </Link>
            </div>
        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
                <div className="mb-6 sm:mb-10 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                    <div className="flex items-center space-x-4 sm:space-x-6 w-full sm:w-auto">
                        ...
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight bg-gradient-to-r from-[#F17905] to-[#d66804] bg-clip-text text-transparent truncate">{note.title}</h1>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                        ...
                        <button 
                            ...
                            className={`group flex items-center px-4 sm:px-6 py-2 sm:py-3 ${isChatOpen ? 'bg-gray-200' : 'bg-gradient-to-r from-[#F17905] to-[#d66804]'} text-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 w-full sm:w-auto justify-center`}
                        >
                    ...
                    <div className={`flex-1 transition-all duration-300 ${isChatOpen ? 'lg:w-2/3' : 'w-full'}`}>
                        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-3xl backdrop-blur-lg backdrop-filter">
                            ...
                            <div className="p-4 sm:p-8 animate-fadeIn">
                                <div className={`transition-all duration-300 transform ${isLoading ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
                                    {activeTab === 'notes' && (
